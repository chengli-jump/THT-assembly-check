...
if __name__ =='__main__':
    ...
    file_directory = 'F:\\siemens\\tht-assembly-check\\tht-assembly-check\config\\wheel.yaml'
    with open(file_directory, 'r', encoding='utf-8') as f:
        config = yaml.load(f, Loader=yaml.FullLoader)
    # path1 = r'raw_images\Picture1.png'

    path1 = r'golden_images\test1.png'
    ...
    cv_show("align_image",compared_image_after_alignment)
